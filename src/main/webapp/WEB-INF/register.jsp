    ...
    <form action="" class="my-10" method="post">
        <div class="flex flex-col space-y-5">
            <label for="name">
                ...
                <input id="name" name="name" type="text" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your name">
            </label>
            <label for="username">
            ...
            <label for="cin">
                <p class="font-medium text-slate-700 pb-2">CIN</p>
                <input id="cin" name="cin" type="text" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your CIN">
            </label>

            <div class="relative pb-2 pt-4" x-data="{ input: 'password' }">
                <p class="font-medium text-slate-700 pb-2">Password</p>
                <input class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" id="password" name="password" type="password" placeholder="Enter your password" x-bind:type="input">
            ...
            <button class="w-full py-3 font-medium text-white bg-blue-500 hover:bg-blue-400 rounded-lg border-blue-400 hover:shadow inline-flex space-x-2 items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                </svg>
                <span>Register</span>
            </button>
            <p class="text-center">Already registered? <a href="login.jsp" class="text-blue-500 font-medium inline-flex space-x-1 items-center"><span>Login </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
